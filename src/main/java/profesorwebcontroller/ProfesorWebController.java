...
public class ProfesorWebController {
    ...
    public String crearProfesor(@Validated @ModelAttribute("profesor") Profesor profesor, BindingResult result,
        ...
        if (profesor.getIdProfesor() != null && servicio.existe(profesor.getIdProfesor())) {
            if (result.hasErrors()) {
    ...
    public String eliminarProfesor(@PathVariable("id") int id, RedirectAttributes flash) {
        try {
            ...
            flash.addFlashAttribute("error",
                    "Este profesor no se puede eliminar debido a restricciones de clave foránea.");
